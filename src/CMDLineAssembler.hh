...
{
class Exec_invalid_escape final : public std::runtime_error
{
...
// wine_compatibility_mode enables more lax parsing to make desktop files
// generated by Wine work. A warning is printed when invalid use of escapes
// are detected (in relation to Wine).
// If set to false, Exec_invalid_escape will be raised if invalid escapes are
// found.
std::vector<std::string>
convert_exec_to_command(std::string_view exec_key,
